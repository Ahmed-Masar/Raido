...
ScrollReveal().reveal("header .button__container", {
  ...scrollRevealOption,
  delay: 1000,
});
...
ScrollReveal().reveal(".about__container .button__container", {
  ...scrollRevealOption,
  delay: 1500,
});
...
ScrollReveal().reveal(".discover__card .discover__card__content", {
  ...scrollRevealOption,
  interval: 500,
  delay: 200,
});
